...
export class NotificationsSettingsPageComponent extends UntilDestroyedMixin implements OnInit {
  ...
  public form = new FormGroup({
    ...
    accountable: new FormControl(false),
  ...
  text = {
    ...
    accountable: this.I18n.t('js.notifications.settings.reasons.accountable'),
  };
  ...
  ngOnInit():void {
    ...
    this.storeService.query.notificationsForGlobal$
      ...
      .subscribe((settings) => {
        ...
        this.form.get('accountable')?.setValue(settings.accountable);
      ...
      .subscribe((settings) => {
        ...
        settings
          ...
          .forEach((setting) => projectSettings.push(new FormGroup({
            ...
            accountable: new FormControl(setting.accountable),
  ...
  public saveChanges():void {
    ...
    const globalPrefs:INotificationSetting = {
      ...
      accountable: notificationSettings.accountable,
    ...
    const projectPrefs:INotificationSetting[] = notificationSettings.projectSettings.map((settings) => ({
      ...
      accountable: settings.accountable,
